...
public class HelpOthersActivity extends AppCompatActivity {
    ...
    private static final String TAG = "HelpOthersActivity";

    private ActivityHelpOthersBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = ActivityHelpOthersBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        initializeVars();
        postData(DataHandler.ALL_REQUESTS);

    }

    private void setRecyclerView(HelpRequest[] helpRequests) {
        binding.recylerView.setLayoutManager(new LinearLayoutManager(this));
        binding.recylerView.setAdapter(new HelpOthersAdapter(this, getSupportFragmentManager(), helpRequests));
    }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            HelpRequest[] helpRequests = gson.fromJson(res, HelpRequest[].class);
                            setRecyclerView(helpRequests);
                        } catch (Exception e) {
